...
- Python GUI app used to controll the microscope: [https://github.com/PeterDirnhofer/tkinter-usb-app](https://github.com/PeterDirnhofer/tkinter-usb-app)  
- Controller board (houses ESP32, controlls, etc.): [https://github.com/PeterDirnhofer/KiCad_RTM_Adapterboard_v3_0](https://github.com/PeterDirnhofer/KiCad_RTM_Adapterboard_v3_0)  
- Transimpendance amplifier (evens the signal out): [https://github.com/PeterDirnhofer/KiCad_RTM_Tunnelling-Amp_v_2_0](https://github.com/PeterDirnhofer/KiCad_RTM_Tunnelling-Amp_v_2_0)  